...
export default function DataPrincipalOrdenes({dictionary}) {
  ...
  const columns = [
    ...
    {
      name: dictionary.TablesOrders.Columns.Type,
    ...
    {
      name: dictionary.TablesOrders.Columns.Price,
      selector: (row) => row.precio,
      sortable: true,
    },
    {
      name: dictionary.TablesOrders.Columns.Building,
  ...
  return (
    <section>
      <div className=" grid sm:flex sm:items-center sm:justify-between mb-4">
        <FloatingLabel
          variant="outlined"
          label={dictionary.TablesOrders.Search}
          onChange={handleChange}
        />
        <NuevaOrden dict = {dictionary}/>
      </div>
