...
export default function FormNuevoRepartidev() {
    ...
    <form
      ...
      >
         <div className="grid">
          ...
          />
          {errors.dni?.type === 'required' && <span className="text-red-600 p-1 text-xs">El campo es requerido</span>}
          {errors.dni?.type === 'maxLength' && <span className="text-red-600 p-1 text-xs">El campo debe tener máximo 8 caracteres</span>}
          {errors.dni?.type === 'minLength' && <span className="text-red-600 p-1 text-xs">El campo debe tener mínimo 8 caracteres</span>}
        </div>
